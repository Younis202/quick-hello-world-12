  ...
  return (
    <div className="page-wrapper">
      ...
      <div id="__next" data-reactroot="">
        ...
        <main id="main-content" className="css-y8aj3r e1jq4geh0" style="padding-top: 0px;">
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-xpta5n">
              <div className="css-1llzy2o">
                <div className="css-j8ny0d">
                  <div className="css-15twnff e5rdxn20">
                    <div className="intro_title">What’s in your water?</div>
                    <div className="intro_text">Discover the most common contaminants in your tap water and learn how they
                      compare to critical health standards.</div>
                    <div className="intro_content">
                      <form>
                        <div className="css-12fcyd0">
                          <div className="css-24qm9l">
                            <div className="analyzeInput css-1mrg6vf es0nyu50">
                              <div className="inputContainer">
                                <div className="inputContainer_inner">
                                  <div className="inputWrap"><input type="text" name="zipCode" aria-invalid="false" id="zipCode"
                                    placeholder="Enter ZIP code" value="" />
                                    <div className="inputAction">
                                      <div><span color="text.default" size="30"
                                        className="analyzeInput_icon css-1cx76uw e13u1hot0"><svg className="css-82n8sf e1x3lr430"
                                          focusable="false" viewBox="0 0 32 32" color="text.default" aria-hidden="true">
                                          <rect width="32" height="32" rx="16" fill="#EBF3F9"></rect>,<path fill="#153A5B"
                                            d="M19 16C19 17.6562 17.6562 19 16 19C14.3125 19 13 17.6562 13 16C13 14.3438 14.3125 13 16 13C17.6562 13 19 14.3438 19 16ZM16 14.5C15.1562 14.5 14.5 15.1875 14.5 16C14.5 16.8438 15.1562 17.5 16 17.5C16.8125 17.5 17.5 16.8438 17.5 16C17.5 15.1875 16.8125 14.5 16 14.5ZM16 8C16.4062 8 16.75 8.34375 16.75 8.75V10.0625C19.4375 10.4062 21.5938 12.5625 21.9375 15.25H23.25C23.6562 15.25 24 15.5938 24 16C24 16.4375 23.6562 16.75 23.25 16.75H21.9375C21.5938 19.4688 19.4375 21.625 16.75 21.9688V23.25C16.75 23.6875 16.4062 24 16 24C15.5625 24 15.25 23.6875 15.25 23.25V21.9688C12.5312 21.625 10.375 19.4688 10.0312 16.75H8.75C8.3125 16.75 8 16.4375 8 16C8 15.5938 8.3125 15.25 8.75 15.25H10.0312C10.375 12.5625 12.5312 10.4062 15.25 10.0625V8.75C15.25 8.34375 15.5625 8 16 8ZM11.5 16C11.5 18.5 13.5 20.5 16 20.5C18.4688 20.5 20.5 18.5 20.5 16C20.5 13.5312 18.4688 11.5 16 11.5C13.5 11.5 11.5 13.5312 11.5 16Z">
                                          </path>
                                        </svg></span></div>
                                    </div>
                                  </div>
                          ...
                          <div className="css-vurnku"><button type="submit" className="analyzeBtn css-5rgnj1 edzyefi0"
                            tabIndex="0">Analyze<span className="btn_icon btn_iconRight"><span color="text.default" size="32"
                              className="css-2s7n6o e13u1hot0"><svg className="css-82n8sf e1x3lr430" focusable="false"
                                viewBox="0 0 32 32" color="text.default" aria-hidden="true">
                    ...
                    <div className="intro_info"><strong>Enter your zip code to see the specific contaminants in your tap
                      water</strong>, how they can affect you, and how to best protect yourself and your family.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-5yjnui">
              <div className="css-19mcf2j">
                <div className="css-1xnfqhj elnmoj50">
                  <div className="contaminants_head">
                    <h2 className="contaminants_headTitle">Most commonly found contaminants</h2>
                  </div>
                  <div className="contaminantsSwiper_inner">
                    <div className="contaminantsSwiper_swiper">
                      <div className="contaminantsSwiper_swiper_inner">
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1a123tm e3l1utq0"
                          href="/water-quality/contaminant/pfas">
                          <div className="css-l3rx45">
                            <div className="pfas-card_title">PFAS</div>
                            <div className="pfas-card_effect">Risk of potential exposure</div>
                          </div>
                          <div className="css-1fjiez5"><span color="text.default" className="css-11qxqh7 e13u1hot0"><svg
                            className="pfas-card_filterEffectivness-icon css-82n8sf e1x3lr430" focusable="false"
                            viewBox="0 0 16 16" color="text.default" aria-hidden="true">
                            <rect width="16" height="16" rx="8" fill="white"></rect>
                            <path fill-rule="evenodd" clip-rule="evenodd"
                              d="M5.51794 12L8.00654 5.88722L10.473 12H11.7944L8.65305 4.58376C8.50315 4.22989 8.15616 4 7.77185 4H5.24349V4.2069C5.24349 4.65866 5.60971 5.02487 6.06156 5.02487H7.25518L4.20703 12H5.51794Z"
                              fill="#153A5B"></path>
                          </svg></span>
                            <div className="pfas-card_filterEffectivness">High filter effectivness</div>
                          </div>
                          <div className="css-g8i27r">
                            <div className="pfas-card_description">Very low exposure to some PFAS chemicals has been linked to
                              cancer, thyroid disease, weakened childhood immunity and many other health problems.</div>
                          </div>
                          <div className="css-g8i27r">
                            <div className="pfas-card_link">Learn more</div>
                          </div>
                        </a></div>
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1xrpb1o er99h9b0"
                          href="/water-quality/contaminant/arsenic">
                          <div className="card_head">
                            <div className="card_headTitle">Arsenic </div>
                            <div className="card_headLabel-wrapper">
                              <div className="card_headLabel"><span>Potential effect:</span> Skin damage or problems with
                                circulatory systems, and may have increased risk of getting cancer</div>
                            </div>
                          </div>
                          <div className="card_larq">
                            <div className="card_larqValue"><span color="text.default" className="css-11qxqh7 e13u1hot0"><svg
                              className="css-82n8sf e1x3lr430" focusable="false" viewBox="0 0 16 16" color="text.default"
                              aria-hidden="true">
                              <path fill="#153A5B" d="M16 8A8 8 0 1 0 0 8a8 8 0 0 0 16 0Z"></path>
                              <path fill="#fff"
                                d="m5.517 12 2.489-6.113L10.472 12h1.322L8.652 4.584A.957.957 0 0 0 7.772 4h-2.53v.207c0 .452.367.818.819.818h1.193L4.206 12h1.311Z"
                                clip-rule="evenodd"></path>
                            </svg></span></div>
                            <div className="card_larqLabel">Moderate filter effectiveness</div>
                          </div>
                          <div className="card_list">
                            <div className="card_listItem">
                              <div className="card_listItem_label">EWG guideline</div>
                              <div className="card_listItem_value">0.004 ppb</div>
                            </div>
                            <div className="card_listItem">
                              <div className="card_listItem_label">National average</div>
                              <div className="card_listItem_value isBold">0.6466 ppb</div>
                            </div>
                          </div>
                          <div className="card_actions"><button aria-label="Open Arsenic page" className="card_actionsCta">Learn
                            more</button></div>
                        </a></div>
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1xrpb1o er99h9b0"
                          href="/water-quality/contaminant/barium">
                          <div className="card_head">
                            <div className="card_headTitle">Barium </div>
                            <div className="card_headLabel-wrapper">
                              <div className="card_headLabel"><span>Potential effect:</span> Increase in blood pressure</div>
                            </div>
                          </div>
                          <div className="card_list">
                            <div className="card_listItem">
                              <div className="card_listItem_label">EWG guideline</div>
                              <div className="card_listItem_value">700 ppb</div>
                            </div>
                            <div className="card_listItem">
                              <div className="card_listItem_label">National average</div>
                              <div className="card_listItem_value isBold">41.51 ppb</div>
                            </div>
                          </div>
                          <div className="card_actions"><button aria-label="Open Barium page" className="card_actionsCta">Learn
                            more</button></div>
                        </a></div>
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1xrpb1o er99h9b0"
                          href="/water-quality/contaminant/haloacetic-acids-haa5">
                          <div className="card_head">
                            <div className="card_headTitle">Haloacetic acids (HAA5)† </div>
                            <div className="card_headLabel-wrapper">
                              <div className="card_headLabel"><span>Potential effect:</span> Increased risk of cancer</div>
                            </div>
                          </div>
                          <div className="card_larq">
                            <div className="card_larqValue"><span color="text.default" className="css-11qxqh7 e13u1hot0"><svg
                            ...
                            <div className="card_larqLabel">High filter effectiveness</div>
                          </div>
                          <div className="card_list">
                            <div className="card_listItem">
                              <div className="card_listItem_label">EWG guideline</div>
                              <div className="card_listItem_value">0.1 ppb</div>
                            </div>
                            <div className="card_listItem">
                              <div className="card_listItem_label">National average</div>
                              <div className="card_listItem_value isBold">17.11 ppb</div>
                            </div>
                          </div>
                          <div className="card_actions"><button aria-label="Open Haloacetic acids (HAA5)† page"
                            className="card_actionsCta">Learn more</button></div>
                        </a></div>
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1xrpb1o er99h9b0"
                          href="/water-quality/contaminant/nitrate">
                          <div className="card_head">
                            <div className="card_headTitle">Nitrate </div>
                            <div className="card_headLabel-wrapper">
                              <div className="card_headLabel"><span>Potential effect:</span> Infants below the age of six
                          ...
                          <div className="card_list">
                            <div className="card_listItem">
                              <div className="card_listItem_label">EWG guideline</div>
                              <div className="card_listItem_value">0.14 ppm</div>
                            </div>
                            <div className="card_listItem">
                              <div className="card_listItem_label">National average</div>
                              <div className="card_listItem_value isBold">0.9351 ppm</div>
                            </div>
                          </div>
                          <div className="card_actions"><button aria-label="Open Nitrate page" className="card_actionsCta">Learn
                            more</button></div>
                        </a></div>
                        <div className="contaminantsSwiper_swiper_item"><a className="css-1xrpb1o er99h9b0"
                          href="/water-quality/contaminant/nitrate-and-nitrite">
                          <div className="card_head">
                            <div className="card_headTitle">Nitrate and nitrite </div>
                            <div className="card_headLabel-wrapper">
                              <div className="card_headLabel"><span>Potential effect:</span> Cancer</div>
                            </div>
                          </div>
                          <div className="card_list">
                            <div className="card_listItem">
                            ...
                            <div className="card_listItem">
                              <div className="card_listItem_label">National average</div>
                              <div className="card_listItem_value isBold">0.8878 ppm</div>
                            </div>
                          </div>
                          <div className="card_actions"><button aria-label="Open Nitrate and nitrite page"
                            className="card_actionsCta">Learn more</button></div>
                        </a></div>
                      </div>
                    </div>
          ...
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-cs41dr">
              <div className="css-19mcf2j">
                <div className="css-y20j9z">
                  <div className="css-55umvm e1gapokb0"><span>† HAA5 is a contaminant group that includes monochloroacetic acid,
                    dichloroacetic acid, trichloroacetic acid, monobromoacetic acid and dibromoacetic a ...
                  </span><button>Read more</button></div>
                </div>
              </div>
            </div>
          </div>
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-1u2ehud">
              <div className="css-1llzy2o">
                <div className="css-1xff7oa e1pjrk260">
                  <div className="map-cta_main-wrapper">
                    <div className="css-17vbkxe eyvhft60"><img
                      src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1727696669/water-quality/water-contaminant-map-216.jpg"
                      alt="whatever" decoding="async" loading="lazy" /></div>
                    <div className="css-1g026t2 eyvhft60"><img
                      src="https://res.cloudinary.com/larq/image/upload/q_auto,f_auto/v1727448847/water-quality/map-mobile.png"
                      alt="whatever" decoding="async" loading="lazy" /></div>
                    <div className="map-cta_wrapper">
                      <div className="map-cta_wrapper_headline">PFAS contamination in the U.S.</div><a
                        href="/water-quality/contaminant/pfas/map" className="map-cta_wrapper_cta css-1gzhfs7 edzyefi0"
                        tabIndex="0">Explore the map<span className="btn_icon btn_iconRight"><span color="text.default"
                          size="40" className="css-libskq e1dp28730"><svg className="css-82n8sf e11de7sb0" focusable="false"
                            viewBox="0 0 40 40" color="text.default" aria-hidden="true" fill="undefined">
                            <path
                              d="M12.332 20C12.332 20.5523 12.7797 21 13.332 21H24.2512L19.2916 25.9595C18.9011 26.3501 18.9011 26.9832 19.2916 27.3738C19.6821 27.7643 20.3153 27.7643 20.7058 27.3738L27.3725 20.7071C27.763 20.3166 27.763 19.6834 27.3725 19.2929L20.7058 12.6262C20.3153 12.2357 19.6821 12.2357 19.2916 12.6262C18.9011 13.0167 18.9011 13.6499 19.2916 14.0404L24.2512 19L13.332 19C12.7797 19 12.332 19.4477 12.332 20Z"
                              fill="#FFFFFF"></path>
                          </svg></span></span></a>
                    </div>
                  </div>
          ...
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-1u2ehud">
              <div className="css-1llzy2o">
                <div className="css-8azsje e1gtnty80">
                  <div className="cardsSwiper_head">
                    <h2 className="cardsSwiper_headTitle">Popular locations</h2>
                  </div>
                  <div className="cardsSwiper_inner">
                    <div className="cardsSwiper_swiper">
                      <div className="cardsSwiper_swiper_inner">
                        <div className="cardsSwiper_swiper_item"><a href="/water-quality/10001">
                          <div className="css-1rhrzul eewzwz00" aria-label="Learn more about New york" target="_blank">
                            <div className="card_head">
                              <div className="card_headLocation">New york</div>
                              <div className="card_headProvider">New York city system</div>
                            </div>
                            <div className="card_body">8</div>
                            <div className="card_footer">Contaminants exceed EWG health guidelines</div>
                            <div className="card_cta">Learn more</div>
                          </div>
                        </a></div>
                        <div className="cardsSwiper_swiper_item"><a href="/water-quality/90001">
                          <div className="css-1rhrzul eewzwz00" aria-label="Learn more about Los Angeles" target="_blank">
                            <div className="card_head">
                              <div className="card_headLocation">Los Angeles</div>
                              <div className="card_headProvider">Department of water and power</div>
                            </div>
                            <div className="card_body">6</div>
                            <div className="card_footer">Contaminants exceed EWG health guidelines</div>
                            <div className="card_cta">Learn more</div>
                          </div>
                        </a></div>
                        <div className="cardsSwiper_swiper_item"><a href="/water-quality/60601">
                          <div className="css-1rhrzul eewzwz00" aria-label="Learn more about Chicago" target="_blank">
                            <div className="card_head">
                              <div className="card_headLocation">Chicago</div>
                              <div className="card_headProvider">City of Chicago</div>
                            </div>
                            <div className="card_body">8</div>
                            <div className="card_footer">Contaminants exceed EWG health guidelines</div>
                            <div className="card_cta">Learn more</div>
          ...
          <div className="css-6inqf5 exuf6kk0">
            <div className="css-d0vs19">
              <div className="css-19mcf2j">
                <div className="css-y20j9z">
                  <div className="css-55umvm e1gapokb0"><span>Includes chemicals detected in 2017-2019 for which annual utility
                    averages exceeded an EWG-selected health guideline established by a federal or state ...
                  </span><button>Read more</button></div>
                </div>
              </div>
            </div>
      ...
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/94a7ad86-21e447d1cd2ccaa7.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2218-9b1436ce7f570f30.js"></script>
      ...
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/210-95a83711762e2052.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/132-b43d9ccffcebbb5a.js"></script>
      ...
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/home/larq-pitcher-purevis-8d835c725744e7c4.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/home/larq-pitcher-e702fceac42254c6.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/5411-22f196c2966ce0a9.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/drinkware/larq-bottle-swig-top-142bd07db3bdf7ef.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/4218-da84116973822611.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2748-6a1c9af97fa12b4c.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/8696-512bbec310ff1637.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/purification/larq-bottle-filtered-flip-top-43b09044bfab75ab.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/accessories/larq-filter-straw-f868931099cdc516.js"></script>
      <script
      ...
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/accessories/bottle-filter-34264220d82c2618.js"></script>
      ...
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/6875-4dc0ec4643fb28ea.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/8891-6927970c46fa70d9.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/5270-384c4f689080f391.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/water-quality-93b6030450bab61a.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/8319bd34-da8b0d6e4388242f.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/5208-04956d977a28c411.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/user/sign-in-12d9b311f14cbd80.js"></script>
