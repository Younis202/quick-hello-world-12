    ...
    <div className="page-wrapper">
      ...
      <div id="__next" data-reactroot="">
        ...
        <main id="main-content" className="css-y8aj3r e1jq4geh0" style="padding-top: 0px;">
          <div className="css-1la905i e1jkjevb0">
            <div role="group"
              aria-label="You are currently in hero area. Image with Larq PureVis™ white Pitcher on wooden base with fruits"
              className="heroContainer">
              <div className="heroContent">
                <h1 className="heroContent_title">Hi, we are LARQ</h1>
                <p className="heroContent_text">LARQ began with a simple vision where innovative technology can be combined with
                  inspirational design to help people access pristine drinking water easily and sustainably.</p>
              </div>
            </div>
          </div>
          <section className="css-nejygk e1cm9nc20">
            <div className="css-6i7yrq">
              <div className="css-19mcf2j">
                <div className="css-1l7sy1y e5uy9gu0">
                  <h2 className="headingTitle">Inspiring change</h2><span aria-hidden="true"
                    className="headingTitle_separator"></span>
                </div>
                <div className="css-6rn1v9">
                  ...
                  <div className="css-1pysja1">
                    <div className="css-qresxn">
                      <h2 className="u-marginTn">You are what you drink. So drink brilliantly</h2>
                      <p>LARQ’s approach to product innovation is driven by a single purpose - we make it easy to opt for
                        the healthier and more sustainable hydration choice, anytime and anywhere.</p>
                      <p>Our award winning lineup of hydration products improves water quality, taste and overall
                        convenience so reaching for that single-use bottle is never a better option.</p>
                    </div>
                  </div>
                </div>
                <div className="css-1qwy2hp">
                  <div className="css-1h690ep">
                    <div className="css-7xh3ex e1nv8j4y0"><img className="css-0 e1nv8j4y1"
                  ...
                  <div className="css-1pysja1">
                    <div className="css-qresxn">
                      <h2 className="u-marginTn">Drink with a purpose</h2>
                      <p className="u-marginBn">Committed to sustainability, a portion of every LARQ purchase gives back,
                        funding environmental nonprofits around the world as well as bringing safe drinking water to
                        billions of people worldwide—because access to clean drinkable water is not a privilege, it's a
                        right.</p>
                    </div>
                  </div>
                </div>
          ...
          <section className="css-4qlhuy e1cm9nc20">
            <div className="css-4gixwa">
              <div className="css-gp474v">
                <div className="css-1l7sy1y e5uy9gu0">
                  <h2 className="headingTitle">#DrinkBrilliantly</h2><span aria-hidden="true"
                    className="headingTitle_separator"></span>
                </div>
                <div className="css-1uee80f">
                  <div className="css-17jx46l e1j5dcrf0">
                    <div className="instagramFeed_inner">
                      <div className="instagramFeed_head">
                        <p>Share a photo of your LARQ Bottle for the chance to be featured! <strong>@livelarq</strong>
                          <strong>#DrinkBrilliantly</strong></p>
                      </div>
                      <div className="css-ptxis3">
                        <div className="css-1te2tjk"><a className="instagramFeed_itemLink" title="Shop LARQ Bottle Movement"
                          ...
                          <div className="instagramFeed_itemInner"><img className="instagramFeed_itemImage"
                            ...
                            <div className="instagramFeed_itemOverlay"><span className="instagramFeed_itemOverlay_icon"><span
                              ...
                              </svg></span></span><span className="instagramFeed_itemOverlay_btn">Shop the bottle</span>
                            </div>
                          </div>
                        </a></div>
                        <div className="css-1te2tjk"><a className="instagramFeed_itemLink" title="Shop LARQ Bottle"
      ...
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/1303-aad7eedd625bec0b.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/purification/larq-bottle-purevis/reviews-585d3743c221e725.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/3855-c3d19f0ef54b3910.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/contact-us-643242c954b4b405.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/press-f24c196b9899aee0.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/2010-7b339352a6eb166b.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/8210-cc2d6a2284e8e198.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/our-story-b767fe8f8bb5180b.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/9425-247791a4d06365c5.js"></script>
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/affiliate-program-812aae5dd1e20f83.js"></script>
      ...
      <script
        src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/exclusive-perks-92d9f8a0cbfbbf12.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/retailers-2153d7e10965ac80.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/support-20404c42052833f9.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/3610-a92d10cfec8e2d42.js"></script>
      <script src="https://d38wbksp4rmv41.cloudfront.net/_next/static/chunks/pages/index-e53a0785f4fca670.js"></script>
    </div>
  );
}
